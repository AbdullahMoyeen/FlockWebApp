...
<html>
    ...
    <head>
        ...
        <title>Flock Update Phone</title>
    ...
    <body>
        ...
        <div class="section">
            ...
            <form:form class="mainForm" method="post" action="/customer/updatePhone/submit" modelAttribute="customerPhone">
                <form:hidden path="customerID" value="${customerPhone.customerID}" />
                <form:hidden path="phoneID" value="${customerPhone.phoneID}" />
                <table class="mainTable" style="margin: auto;">
                    <tr>
                        ...
                        <td>
                            <form:select path="phoneTypeCode" required="true">
                                <form:option value="${customerPhone.phoneTypeCode}" label="${customerPhone.phoneTypeName}"/>
                    ...
                    <tr>
                        <td>Phone Number</td>
                        <td>:</td>
                        <td><form:input path="phoneNumber" value="${customerPhone.phoneNumber}" required="true" maxlength="10" /></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td><input type="submit" value="Save" title="Update phone"/></td>
                    </tr>
                </table>
            </form:form>
