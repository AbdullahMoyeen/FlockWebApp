        ...
        <div class="section">
            ...
            <table class="childTable" border="1" style="width: 100%;margin: auto;border-spacing: 10px;empty-cells: show;">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none" href="<c:url value="/admin/group/event/details?eventId=${adminGroupEvent.eventId}&groupId=${adminGroupEvent.groupId}"/>"><c:if test="${adminGroupEvent.isPrivateEvent}">Y</c:if></a></td>
