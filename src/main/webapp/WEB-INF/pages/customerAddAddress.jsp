...
<html>
    ...
    <body>
        ...
        <div class="nav">
            ...
            <table width="100%" style="margin: auto;">
                <tr>
                    ...
                    <th><a href="<c:url value="/"/>">About Us</a></th>
                    <th><a href="<c:url value="/"/>">Contact Us</a></th>
                    <th>
                        <security:authorize access="isAuthenticated()">
        ...
        <div class="section">
            ...
            <form:form class="mainForm" method="post" action="/customer/addAddress/submit" modelAttribute="customerAddress">
                <form:hidden path="customerID" value="${customerAddress.customerID}" />
                <table class="mainTable" style="margin: auto;">
                    <tr>
                        <td>Address Line 1</td>
                        <td>:</td>
                        <td><form:input path="addressLine1" required="true" maxlength="200" title="Maximum 200 characters"/></td>
                    </tr>
                    <tr>
                        <td>Address Line 2</td>
                        <td>:</td>
                        <td><form:input path="addressLine2" maxlength="200" title="Maximum 200 characters"/></td>
                    </tr>
                    <tr>
                        <td>City</td>
                        <td>:</td>
                        <td><form:input path="city" required="true" title="Enter city"/></td>
                    </tr>
                    <tr>
                        <td>State</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Zip Code</td>
                        <td>:</td>
                        <td><form:input path="postalCode" required="true" title="Enter zip code"/></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
