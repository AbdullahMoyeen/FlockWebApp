...
<html>
    ...
    <body>
        ...
        <div class="section">
            ...
            <c:url value="/customer/updatePassword/submit" var="formUrl"/>
            <form:form class="mainForm" method="post" action="${formUrl}" modelAttribute="customer">
                ...
                <table class="mainTable" style="margin: auto;">
                    <caption style="font-size: x-large;font-weight: bold;text-decoration: underline;padding: 20px">Reset Password</caption>
                    <tr>
                        <th>New Password</th>
                        <td>:</td>
                    ...
                    <tr>
                        <td><input type="button" value="Cancel" onclick="location.href='<c:url value="/customer/viewProfile?customerID=${customer.customerID}"/>'" title="Cancel and go back to your profile"></td>
                        <td></td>
